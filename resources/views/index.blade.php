...
<body class="text-white overflow-x-hidden">
    ...
    <nav
        ...
        id="navbar"
    >
        <div class="max-w-screen-2xl mx-auto pl-0 px-6 py-6 flex items-center justify-between">

            <a href="#" class="flex items-center gap-3 text-2xl font-black tracking-wider">
